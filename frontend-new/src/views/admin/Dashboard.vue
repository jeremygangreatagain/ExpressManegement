<template>
  <div class="min-h-screen bg-gray-100 p-6">
    <h1 class="text-2xl font-bold text-orange-500 mb-6">管理员仪表盘</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-gray-700 text-base font-medium mb-4">订单状态分布</h3>
        <div ref="orderStatusChart" class="w-full h-64"></div>
      </div>
      
      <!-- 近期订单趋势折线图 -->
      <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-gray-700 text-base font-medium mb-4">近期订单趋势</h3>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      <div class="p-6 border-b border-gray-200">
        <h3 class="text-gray-700 text-base font-medium">最近订单</h3>
      </div>
...
import { getAdminDashboardData, getRecentOrders, getOrderStatusDistribution, getOrderTrend } from '../../api/dashboard'
